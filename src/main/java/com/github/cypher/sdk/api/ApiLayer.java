...
public interface ApiLayer {
	...
	/**
	 * Lists the public rooms on the roomcollection.
	 ...
	 * @param transactionId The transaction ID for this event. The client should generate an ID unique across requests with the same access token; it will be used by the roomcollection to ensure idempotency of requests
	 * @param content Event content (e.g. '{"msgtype": "m.text", "body": "I know kung fu" }')
	 * @return Valid Json response containing the event id generated by the roomcollection
	 */
